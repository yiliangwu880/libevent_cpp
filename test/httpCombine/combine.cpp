...
namespace {
	...
	void Test::OnRandomReq()
	{
		...
		{
			m_tm.StopTimer();
			UNIT_INFO("stop WAIT_RANDOM_REQ, error_cnt, correct_cnt %d %d", error_cnt, correct_cnt);
			Start_WAIT_ERROR_RSP();
			return;
		}
	...
	void Test::Start_WAIT_ERROR_RSP()
	{
